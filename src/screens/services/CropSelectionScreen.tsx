...
export const CropSelectionScreen: React.FC<HomeScreenProps<'CropSelection'>> = ({ navigation }) => {
  ...
  const crops = [
    ...
    },
    {
      ...
      name: t('soybean'),
      tag: t('lowWaterTag'),
      yield: t('soybeanYield'),
      water: t('lowMediumWater'),
      duration: t('soybeanDuration'),
    ...
    },
    {
      id: 'sugarcane',
      name: t('sugarcane'),
      tag: t('longTermReturnTag'),
      yield: t('sugarcaneYield'),
      water: t('highWater'),
      duration: t('sugarcaneDuration'),
